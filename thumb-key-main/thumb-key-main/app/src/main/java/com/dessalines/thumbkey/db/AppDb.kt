...
const val DEFAULT_KEYBOARD_OPACITY = 100
const val DEFAULT_TOUCH_THROUGH_ENABLED = 0
const val DEFAULT_HELPER_FULL_OPACITY = 0
const val DEFAULT_ZERO_HEIGHT_INSETS = 0
const val DEFAULT_FLOATING_CHAR_ENABLED = 0
// Floating char animation physics (stored as Int, scaled — see FloatingCharOverlay for usage)
const val DEFAULT_FLOATING_CHAR_SPEED = 1400      // px/s, used directly
const val DEFAULT_FLOATING_CHAR_STEERING = 70     // ×100 → 7000 px/s² homing accel
const val DEFAULT_FLOATING_CHAR_DAMPING = 35      // ÷10  → 3.5f per-second drag
const val DEFAULT_FLOATING_CHAR_DRAG_SCALE = 45   // ÷100 → 0.45f swipe-vel inherit
const val DEFAULT_FLOATING_CHAR_MAX_TIME = 12     // ÷10  → 1.2f seconds time-of-flight
...
data class AppSettings(
    ...
    @ColumnInfo(
        name = "keyboard_opacity",
        defaultValue = DEFAULT_KEYBOARD_OPACITY.toString(),
    )
    val keyboardOpacity: Int = DEFAULT_KEYBOARD_OPACITY,
    @ColumnInfo(
        name = "touch_through_enabled",
        defaultValue = DEFAULT_TOUCH_THROUGH_ENABLED.toString(),
    )
    val touchThroughEnabled: Int = DEFAULT_TOUCH_THROUGH_ENABLED,
    @ColumnInfo(
        name = "helper_full_opacity",
        defaultValue = DEFAULT_HELPER_FULL_OPACITY.toString(),
    )
    val helperFullOpacity: Int = DEFAULT_HELPER_FULL_OPACITY,
    @ColumnInfo(
        name = "zero_height_insets",
        defaultValue = DEFAULT_ZERO_HEIGHT_INSETS.toString(),
    )
    val zeroHeightInsets: Int = DEFAULT_ZERO_HEIGHT_INSETS,
    @ColumnInfo(
        name = "floating_char_enabled",
        defaultValue = DEFAULT_FLOATING_CHAR_ENABLED.toString(),
    )
    val floatingCharEnabled: Int = DEFAULT_FLOATING_CHAR_ENABLED,
    @ColumnInfo(
        name = "floating_char_speed",
        defaultValue = DEFAULT_FLOATING_CHAR_SPEED.toString(),
    )
    val floatingCharSpeed: Int = DEFAULT_FLOATING_CHAR_SPEED,
    @ColumnInfo(
        name = "floating_char_steering",
        defaultValue = DEFAULT_FLOATING_CHAR_STEERING.toString(),
    )
    val floatingCharSteering: Int = DEFAULT_FLOATING_CHAR_STEERING,
    @ColumnInfo(
        name = "floating_char_damping",
        defaultValue = DEFAULT_FLOATING_CHAR_DAMPING.toString(),
    )
    val floatingCharDamping: Int = DEFAULT_FLOATING_CHAR_DAMPING,
    @ColumnInfo(
        name = "floating_char_drag_scale",
        defaultValue = DEFAULT_FLOATING_CHAR_DRAG_SCALE.toString(),
    )
    val floatingCharDragScale: Int = DEFAULT_FLOATING_CHAR_DRAG_SCALE,
    @ColumnInfo(
        name = "floating_char_max_time",
        defaultValue = DEFAULT_FLOATING_CHAR_MAX_TIME.toString(),
    )
    val floatingCharMaxTime: Int = DEFAULT_FLOATING_CHAR_MAX_TIME,
    @ColumnInfo(
        name = "floating_char_max_count",
        defaultValue = DEFAULT_FLOATING_CHAR_MAX_COUNT.toString(),
    )
    val floatingCharMaxCount: Int = DEFAULT_FLOATING_CHAR_MAX_COUNT,
    @ColumnInfo(
        name = "floating_char_realistic_gravity",
        defaultValue = DEFAULT_FLOATING_CHAR_REALISTIC_GRAVITY.toString(),
    )
    val floatingCharRealisticGravity: Int = DEFAULT_FLOATING_CHAR_REALISTIC_GRAVITY,
    @ColumnInfo(
        name = "floating_char_impact_velocity",
...
data class LookAndFeelUpdate(
    ...
    val touchThroughEnabled: Int,
    @ColumnInfo(
        name = "helper_full_opacity",
    )
    val helperFullOpacity: Int,
    @ColumnInfo(
        name = "zero_height_insets",
    )
    val zeroHeightInsets: Int,
    @ColumnInfo(
        name = "floating_char_enabled",
    )
    val floatingCharEnabled: Int,
    @ColumnInfo(name = "floating_char_speed")
    val floatingCharSpeed: Int,
    @ColumnInfo(name = "floating_char_steering")
    val floatingCharSteering: Int,
    @ColumnInfo(name = "floating_char_damping")
    val floatingCharDamping: Int,
    @ColumnInfo(name = "floating_char_drag_scale")
    val floatingCharDragScale: Int,
    @ColumnInfo(name = "floating_char_max_time")
    val floatingCharMaxTime: Int,
    @ColumnInfo(name = "floating_char_max_count")
    val floatingCharMaxCount: Int,
    @ColumnInfo(name = "floating_char_realistic_gravity")
