...
val MIGRATION_24_25 =
    object : Migration(24, 25) {
        override fun migrate(db: SupportSQLiteDatabase) {
            db.execSQL(
                "ALTER TABLE AppSettings ADD COLUMN keyboard_opacity INTEGER NOT NULL DEFAULT $DEFAULT_KEYBOARD_OPACITY",
            )
            db.execSQL(
                "ALTER TABLE AppSettings ADD COLUMN touch_through_enabled INTEGER NOT NULL DEFAULT $DEFAULT_TOUCH_THROUGH_ENABLED",
            )
        }
    }
...
val MIGRATION_25_26 =
    object : Migration(25, 26) {
        override fun migrate(db: SupportSQLiteDatabase) {
            db.execSQL(
                "ALTER TABLE AppSettings ADD COLUMN helper_full_opacity INTEGER NOT NULL DEFAULT $DEFAULT_HELPER_FULL_OPACITY",
            )
        }
    }
...
val MIGRATION_26_27 =
    object : Migration(26, 27) {
        override fun migrate(db: SupportSQLiteDatabase) {
            db.execSQL(
                "ALTER TABLE AppSettings ADD COLUMN zero_height_insets INTEGER NOT NULL DEFAULT $DEFAULT_ZERO_HEIGHT_INSETS",
            )
            db.execSQL(
                "ALTER TABLE AppSettings ADD COLUMN floating_char_enabled INTEGER NOT NULL DEFAULT $DEFAULT_FLOATING_CHAR_ENABLED",
            )
        }
    }
...
val MIGRATION_27_28 =
    object : Migration(27, 28) {
        override fun migrate(db: SupportSQLiteDatabase) {
            db.execSQL(
                "ALTER TABLE AppSettings ADD COLUMN floating_char_speed INTEGER NOT NULL DEFAULT $DEFAULT_FLOATING_CHAR_SPEED",
            )
            db.execSQL(
                "ALTER TABLE AppSettings ADD COLUMN floating_char_steering INTEGER NOT NULL DEFAULT $DEFAULT_FLOATING_CHAR_STEERING",
            )
            db.execSQL(
                "ALTER TABLE AppSettings ADD COLUMN floating_char_damping INTEGER NOT NULL DEFAULT $DEFAULT_FLOATING_CHAR_DAMPING",
            )
            db.execSQL(
                "ALTER TABLE AppSettings ADD COLUMN floating_char_drag_scale INTEGER NOT NULL DEFAULT $DEFAULT_FLOATING_CHAR_DRAG_SCALE",
            )
        }
    }
...
val MIGRATION_28_29 =
    object : Migration(28, 29) {
        override fun migrate(db: SupportSQLiteDatabase) {
            db.execSQL(
                "ALTER TABLE AppSettings ADD COLUMN floating_char_max_time INTEGER NOT NULL DEFAULT $DEFAULT_FLOATING_CHAR_MAX_TIME",
            )
            db.execSQL(
                "ALTER TABLE AppSettings ADD COLUMN floating_char_max_count INTEGER NOT NULL DEFAULT $DEFAULT_FLOATING_CHAR_MAX_COUNT",
            )
        }
    }
...
val MIGRATION_29_30 =
    object : Migration(29, 30) {
        override fun migrate(db: SupportSQLiteDatabase) {
            db.execSQL(
                "ALTER TABLE AppSettings ADD COLUMN floating_char_realistic_gravity INTEGER NOT NULL DEFAULT $DEFAULT_FLOATING_CHAR_REALISTIC_GRAVITY",
            )
        }
    }
...
val MIGRATION_30_31 =
    object : Migration(30, 31) {
        override fun migrate(db: SupportSQLiteDatabase) {
            db.execSQL(
                "ALTER TABLE AppSettings ADD COLUMN floating_char_impact_velocity INTEGER NOT NULL DEFAULT $DEFAULT_FLOATING_CHAR_IMPACT_VELOCITY",
            )
        }
    }
